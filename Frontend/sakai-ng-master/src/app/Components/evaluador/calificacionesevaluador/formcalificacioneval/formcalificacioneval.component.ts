...
@Component({
  selector: 'app-formcalificacioneval',
  templateUrl: './formcalificacioneval.component.html',
  styleUrls: ['./formcalificacioneval.component.css']
})
export class FormCalificacionEvalComponent implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    ...
    try {
      ...
      if (idCalificacion) {
        ...
        this.usuarioEvaluador =
          await firstValueFrom(
            this.usuarioService.getUsuarioPorId(
              this.calificacion.evaluadorId
            )
          );
      ...
      if (idProyecto) {
        ...
        const idusuarioevaluador =
          Number(params['idusuarioevaluador']);
  ...
  async CalificarProyecto(): Promise<void> {
    ...
    try {
      ...
      this.router.navigate([
        '/evaluador/calificacionesevaluador/calificacioneseval'
      ]);
