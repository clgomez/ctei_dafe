...
@Component({
  selector: 'app-calificacionestut',
  templateUrl: './calificacionestut.component.html',
  styleUrls: ['./calificacionestut.component.css']
})
export class CalificacionesTutComponent implements OnInit {
    ...
    this.authService.currentUser.subscribe(user => {
      ...
      this.usuarioService
        ...
        .subscribe(usuario => {
          ...
          this.usuarioTutor = usuario;

          this.cargarCalificacionesPorIdUsuarioTutor();
  ...
  cargarCalificacionesPorIdUsuarioTutor(): void {

    this.calificacionService
      .getCalificacionesPorIdUsuarioTutor(
