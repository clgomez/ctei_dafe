...
public class Usuario {
    ...
    @JsonIgnore
    @OneToMany(mappedBy = "usuarioInvestigador")
    private List<Calificacion> calificacionesParaElInvestigador;

    @JsonIgnore
    @OneToMany(mappedBy = "usuarioTutor")
    private List<Calificacion> calificacionesDelTutor;

    @JsonIgnore
    @OneToMany(mappedBy = "usuarioEvaluador")
    private List<Calificacion> calificacionesDelEvaluador;
    ...
    public Usuario(String nombre, String apellidos, String direccion, String email, String estado, LocalDate fechaNacimiento, TipoIdentificacionEnum tipoIdentificacion, String identificacion, GeneroEnum genero, OcupacionEnum ocupacion, String username, String password, String telefono) {
        this.nombre = nombre;
