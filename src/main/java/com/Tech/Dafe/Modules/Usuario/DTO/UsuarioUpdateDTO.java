...
public class UsuarioUpdateDTO {
    ...
    @EdadMinima(min = 9, message = "Debes tener al menos 9 años para actualizar la fecha de nacimiento")
    @EdadMaxima(max = 80, message = "La edad no puede ser mayor a 80 años para actualizar la fecha de nacimiento")
    ...
    public UsuarioUpdateDTO(Long id, String nombre) {
        this.nombre = nombre;
    }
